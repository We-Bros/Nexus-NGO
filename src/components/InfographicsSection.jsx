    ...
    <section className="infographics-section section-padding" id="infographics">
      <div className="container">
        <div className="section-title">
          ...
          <h2>Human Rights Core Framework</h2>
          <p>
            Official educational infographics and constitutional rights charters of Nexus Human Rights Council of India.
          </p>
        </div>

        {/* 2-Poster Educational Gallery Grid */}
        {infographics.length > 0 && (
          <div className="infographics-gallery-grid-2">
              ...
              <div 
                ...
                onKeyDown={(e) => {
                  if (e.key === 'Enter' || e.key === ' ') {
                    onOpenLightbox(item.image, item.title, item.subtitle);
                  }
                }}
              >
